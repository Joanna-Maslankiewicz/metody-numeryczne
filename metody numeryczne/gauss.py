"""Klasa realizujaca metode Gaussa"""
...
class Gauss:
    ...
    def eliminacja(self, wyswietlaj = 0):
        """Wykonuje eliminacje Gaussa i zwraca na wyjsciu:
        ...
        for i in range(self.n - 1):
            ...
            #wykonuje eliminacje elementow pod przekatna w i-tej kolumnie
    ...
    def sprawdz_rozwiazanie(self, norma):
        """Metoda wyznaczajaca niedkokladnosc rozwiazania"""
